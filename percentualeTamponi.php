<?php
  ...
  for($i = 10; $i > 0; $i--) {
    ...
    $percentualeTamponi[$handler] = array("y" => round($datiLetti[1][14]/$datiLetti[1][13], 2, PHP_ROUND_HALF_UP), "label" => $dataDati);
    $handler++;
  }
  ...
  <script>
    window.onload = function() {
      var chart = new CanvasJS.Chart("chartContainer", {
        ...
        theme: "light2",
        axisY: {
          title: "Percentuale positivi su tamponi",
        ...
        data: [{
          type: "column",
          name: "Tamponi",
          legendText: "Percentuale tamponi",
          showInLegend: true,
          dataPoints:<?php echo json_encode($percentualeTamponi, JSON_NUMERIC_CHECK); ?>
        }]
      });
      chart.render();
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
    ...
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">Percentuale positivi su tamponi</span>
      </div>
    </header>
