<?php
  ...
  for($i = 10; $i > 0; $i--) {
    ...
    $terapiaIntensiva[$handler] = array("y" => $datiLetti[1][3], "label" => $dataDati);
    $handler++;
  }
  ...
  <script>
    window.onload = function() {
      var chart = new CanvasJS.Chart("chartContainer", {
        ...
        theme: "light2",
        axisY: {
          title: "Totale persone in terapia intensiva",
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
    ...
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">Totale persone in terapia intensiva</span>
      </div>
    </header>
