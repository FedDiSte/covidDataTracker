<?php
  ...
  for($i = 10; $i > 0; $i--) {
    ...
    $totaleDeceduti[$handler] = array("y" => $datiLetti[1][10], "label" => $dataDati);
    $handler++;
  }
    ...
    window.onload = function() {
      var chart = new CanvasJS.Chart("chartContainer", {
        ...
        data: [{
          ...
          legendText: "Deceduti",
          showInLegend: true,
          dataPoints:<?php echo json_encode($totaleDeceduti, JSON_NUMERIC_CHECK); ?>
        }]
      });
      chart.render();
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
    ...
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">Totale deceduti</span>
      </div>
    </header>
